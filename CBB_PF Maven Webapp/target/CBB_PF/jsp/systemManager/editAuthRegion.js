...
var tree = new Tree.TreePanel({  
    ...
    loader: new Tree.TreeLoader({   
    	//dataUrl:'user-management!getAuthTreeNodes.action?menuId=0'
    }),
    listeners : {
    	click: function(node) {  
        },
    	beforeload:function(node){
    			tree.loader.dataUrl='user-management!getAuthTreeNodes.action?id='+id+'&menuId='+node.id;   
    	},
...
function saveAuthRegion() {
	...
	Ext.Ajax.request({
	    url: 'user-management!saveAuthRegionData.action', 
	    method : 'POST',
	    params: {// 请求参数
	    	'id':id,
			'name':name,
...
function getMenuAuthsByAuthDomainId(){
	...
	Ext.Ajax.request({
	    url: 'user-management!getMenuAuthsByAuthDomainId.action', 
	    method : 'POST',
	    params: {// 请求参数
	    	'id':id
			},
