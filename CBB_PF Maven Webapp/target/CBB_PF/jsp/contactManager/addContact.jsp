...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/ext-lang-zh_CN.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/expandExt/ux-all.js"></script> 
<script type="text/javascript" src="../commonManager/common.js"></script>
<script type="text/javascript" src="../codeManager/common.js"></script>
