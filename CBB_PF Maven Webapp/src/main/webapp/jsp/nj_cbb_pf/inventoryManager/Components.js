...
//		if(isInventoryReadOnly(record)){
			...
			Ext.Ajax.request({
				scope: this,
				url : 'n-jcommon!delInventory.action',
				method : "POST",
				params : param,
...
//		}
	...
	getReceiptInventory_single : function (record){
			...
			if(data){
				...
				if(infoForm){
					var copyFields=[
		                ...
		                "LOGISTICS_NO","LOGISTICS_CODE","CUSTOM_CODE","RECEIVER_ID","CHK_CUSTOM_CODE","APP_UID",
		                "IE_FLAG","TRAF_MODE","TRAF_NAME","VOYAGE_NO","BILL_NO",
