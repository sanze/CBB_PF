...
public class ImportCommonAction extends AbstractAction{

	@Resource
	public IImportCommonManagerService importCommonManagerService;

	@IMethodLog(desc = "import入库列表查询")
	public String getAllDeliveries(){
		try {
			Map<String,Object> data = importCommonManagerService.getAllDeliveries(params);
	...
	@IMethodLog(desc = "import入库信息保存/提交")
	public String setDelivery(){
		try {
			...
			if("mod".equals(editType)){
				importCommonManagerService.setDelivery(params,false);
			}else{
				importCommonManagerService.addDelivery(params);
			}
...
//			result.setReturnMessage(e.getErrorMessage());
	...
	@IMethodLog(desc = "import商品删除")
	public String delDelivery(){
		try {
			importCommonManagerService.delDelivery(params);
	...
	public String setOrder(){
		try {
			...
			if("mod".equals(editType)){
				importCommonManagerService.setOrder(params,false);
			}else{
				importCommonManagerService.addOrder(params);
			}
			Map<String,Object> data = new HashMap<String, Object>();
			data.put("success", true);
			resultObj = JSONObject.fromObject(data);
	...
	@IMethodLog(desc = "import订单列表查询")
	public String getAllOrders(){
		try {
			Map<String,Object> data = importCommonManagerService.getAllOrders(params);
	...
	@IMethodLog(desc = "import订单删除")
	public String delOrder(){
		try {
			importCommonManagerService.delOrder(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	@IMethodLog(desc = "import批量提交订单")
	public String batchSubmit_order(){
		try {
			importCommonManagerService.batchSubmit_ORDER(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	@IMethodLog(desc = "import运单列表查询")
	public String getAllLogisticses(){
		try {
			
			Map<String,Object> data = importCommonManagerService.getAllLogisticses(params);
	...
	@IMethodLog(desc = "import运单保存/提交/状态设置")
	public String setLogistics(){
		try {
			...
			if("modStatus".equals(editType)){
				importCommonManagerService.setLogistics(params,true);
			}else if("mod".equals(editType)){
				importCommonManagerService.setLogistics(params,false);
			}else{
				importCommonManagerService.addLogistics(params);
			}
			Map<String,Object> data = new HashMap<String, Object>();
			data.put("success", true);
			//data.put("msg", "");
...
//			result.setReturnMessage(e.getErrorMessage());
	...
	@IMethodLog(desc = "import运单删除")
	public String delLogistics(){
		try {
			importCommonManagerService.delLogistics(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	@IMethodLog(desc = "import清单列表查询")
	public String getAllInventorys(){
		try {
			Map<String,Object> data = importCommonManagerService.getAllInventorys(params);
			JsonConfig jsonConfig = new JsonConfig();
		    PropertyFilter filter = new PropertyFilter() {
		            public boolean apply(Object object, String fieldName, Object fieldValue) {
		            	return null == fieldValue;
	...
	@IMethodLog(desc = "import清单删除")
	public String delInventory(){
		try {
			importCommonManagerService.delInventory(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	@IMethodLog(desc = "import批量提交清单")
	public String batchSubmit_inventory(){
		try {
			importCommonManagerService.batchSubmit_INVENTORY(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	public String setInventory(){
		try {
			...
			if("mod".equals(editType)){
				importCommonManagerService.setInventory(params,false);
			}else{
				importCommonManagerService.addInventory(params);
			}
			Map<String,Object> data = new HashMap<String, Object>();
			data.put("success", true);
			resultObj = JSONObject.fromObject(data);
	...
	@IMethodLog(desc = "import批量提交运单")
	public String batchSubmit_logistics(){
		try {
			importCommonManagerService.batchSubmit_LOGISTICS(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	@IMethodLog(desc = "import批量提交运单状态")
	public String batchSubmit_logisticsStatus(){
		try {
			importCommonManagerService.batchSubmit_LOGISTICS_STATUS(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	@IMethodLog(desc = "import批量申请快递单号")
	public String applyExpressNo(){
		try {
			importCommonManagerService.applyExpressNo_LOGISTICS(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
	...
	public String getAllPayes(){
		try {
			...
			Map<String,Object> data = importCommonManagerService.getAllPayes(params);
	...
	public String setPay(){
		try {
			...
			if("mod".equals(editType)){
				importCommonManagerService.setPay(params);
			}else{
				importCommonManagerService.addPay(params);
			}
			Map<String,Object> data = new HashMap<String, Object>();
			data.put("success", true);
			resultObj = JSONObject.fromObject(data);
	...
	public String delPay(){
		try {
			importCommonManagerService.delPay(params);
			result.setReturnResult(CommonDefine.SUCCESS);
			resultObj = JSONObject.fromObject(result);
		} catch (CommonException e) {
			result.setReturnResult(CommonDefine.FAILED);
...
//		params.put("RECEIVER_ID", RECEIVER_ID);
	...
	public void setDELIVERY_NO(String DELIVERY_NO){
		params.put("DELIVERY_NO", DELIVERY_NO);
	}
	public void setTRAF_NO(String TRAF_NO){
		params.put("TRAF_NO", TRAF_NO);
	}
