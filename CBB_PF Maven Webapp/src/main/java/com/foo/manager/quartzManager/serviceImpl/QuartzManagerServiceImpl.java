package com.foo.manager.quartzManager.serviceImpl;
...
import com.foo.dao.mysql.QuartzManagerMapper;
import com.foo.handler.ExceptionHandler;
import com.foo.listener.QuartzJobListener;
import com.foo.manager.quartzManager.service.QuartzManagerService;
...
public class QuartzManagerServiceImpl extends QuartzManagerService {
	...
	private String jobPrifix = "job_";
	private String triggerPrifix = "trigger_";
	...
	@Override
	public void addJob(int jobType, Class jobClass,
			String cronExpression) throws CommonException{
		
		String jobName = jobPrifix+jobType;
		String triggerName = triggerPrifix+jobType;
	...
	@Override
	public void ctrlJob(int jobType, int jobFlag)  throws CommonException{
...
//				System.out.println("JOB_DELETE");
	...
	@Override
	public void modifyJobTime(int jobType, String cronExpression)  throws CommonException{
		String jobName = jobPrifix+jobType;
		String triggerName = triggerPrifix+jobType;
	...
	@Override
	public boolean IsJobExist(int jobType) throws CommonException{
		String jobName = jobPrifix+jobType;
//		String triggerName = triggerPrifix+jobType;
		JobDetail job;
		try {
	...
	@Override
	public Map<String, Object> getJobInfo(int jobType)  throws CommonException{
//		String jobName = jobPrifix+jobType;
		String triggerName = triggerPrifix+jobType;
